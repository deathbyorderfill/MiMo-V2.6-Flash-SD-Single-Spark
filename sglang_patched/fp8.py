...
class Fp8Config(QuantizationConfig):
    ...
    def get_quant_method(
        ...
        if isinstance(layer, LinearBase):
            ...
            # mimo26: routed experts stored as NVFP2/lm20 2-bit codes (opt3/mimo26/convert_mimo_nvfp2.py)
            # inside an otherwise block-FP8 checkpoint. Enabled by SGLANG_NVFP2_LM20=1;
            # SGLANG_NVFP2_GROUP = block-scale group of the converted checkpoint (16 or 32).
            import os as _os

            if _os.environ.get("SGLANG_NVFP2_LM20", "0") == "1":
                from sglang.srt.layers.quantization.modelopt_quant import (
                    ModelOptFp4Config,
                    ModelOptNvFp2Lm20FusedMoEMethod,
                )

                return ModelOptNvFp2Lm20FusedMoEMethod(
                    ModelOptFp4Config(
                        is_checkpoint_nvfp4_serialized=True,
                        group_size=int(_os.environ.get("SGLANG_NVFP2_GROUP", "32")),
                    )
                )
