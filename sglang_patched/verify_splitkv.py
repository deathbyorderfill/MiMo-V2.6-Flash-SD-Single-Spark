...
def can_handle(
    ...
    # mimo26: plain GQA with qk_dim != v_dim (MiMo 192/128) is fine -- the kernel carries
    # separate HEAD_DIM / V_HEAD_DIM tiles. MLA never reaches this backend on this box.
    if q_extend.shape[2] != v_extend.shape[2] and k_buffer.shape[1] != v_buffer.shape[1]:
        return False
